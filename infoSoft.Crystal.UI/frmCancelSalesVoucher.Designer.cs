namespace tv.Crystal.UI
{
	partial class frmCancelSalesVoucher
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtRefNo = new tv.Crystal.UI.nTextBox(this.components);
			...
			// gbxControls
			// 
			this.gbxControls.Controls.Add(this.txtRefNo);
			this.gbxControls.Controls.Add(this.lblReferenceNo);
			...
			this.txtRefNo.RangeFrom = new System.DateTime(((long)(0)));
			this.txtRefNo.RangeTo = new System.DateTime(((long)(0)));
			this.txtRefNo.Size = new System.Drawing.Size(70, 22);
			this.txtRefNo.TabIndex = 4;
			this.txtRefNo.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// lblReferenceNo
			// 
			this.lblReferenceNo.Location = new System.Drawing.Point(857, 40);
			this.lblReferenceNo.Name = "lblReferenceNo";
			this.lblReferenceNo.Size = new System.Drawing.Size(110, 13);
			this.lblReferenceNo.TabIndex = 5;
			this.lblReferenceNo.Text = "Reference No:";
			this.lblReferenceNo.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// btnSearch
			// 
			...
			this.btnSearch.Location = new System.Drawing.Point(1038, 38);
