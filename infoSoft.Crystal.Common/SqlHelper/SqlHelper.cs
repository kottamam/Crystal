...
namespace tv.Crystal.Common.SqlHelper
{
    /// <summary>
    ...
    public sealed class SqlHelper
    {
        ...
        private static void PrepareCommand(SqlCommand command, SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection, int commandTimeout)
        {
            if (command == null) throw new ArgumentNullException("command");
        ...
        {
            // fwd to real implementation with command's timeout (default or otherwise)
            PrepareCommand(command, connection, transaction, commandType, commandText, commandParameters, out mustCloseConnection, command.CommandTimeout);
        }
        ...
        /// <param name="command"></param>
        /// <returns></returns>
        public static int ExecuteNonQuery(SqlTransaction transaction, SqlCommand command)
        {
            command.Transaction = transaction;
        ...
        public static int ExecuteNonQuery(SqlConnection connection, SqlTransaction transaction, SqlCommand command)
        {
            int returnValue = 0;

            if (connection == null && transaction == null)
            {
                throw new ArgumentNullException("transaction and connection are null");
            }

            if (connection != null && transaction != null)
            {
                throw new ArgumentException("Transaction and connection cannot both be passed in");
            }
            ...
            if (connection == null && transaction != null)
            {
                ...
                returnValue = ExecuteNonQuery(transaction.Connection, command);
            }
        ...
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <param name="commandTimeout">Timeout period in seconds for this command to execute</param>
        /// <returns>An int representing the number of rows affected by the command</returns>
        ...
        public static int ExecuteNonQuery(SqlConnection connection, CommandType commandType, string commandText, int commandTimeout, params SqlParameter[] commandParameters)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            bool mustCloseConnection = false;
            PrepareCommand(cmd, connection, (SqlTransaction)null, commandType, commandText, commandParameters, out mustCloseConnection, commandTimeout);
        ...
        public static int ExecuteNonQuery(SqlTransaction transaction, CommandType commandType, string commandText, int commandTimeout, params SqlParameter[] commandParameters)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            bool mustCloseConnection = false;
            PrepareCommand(cmd, transaction.Connection, transaction, commandType, commandText, commandParameters, out mustCloseConnection, commandTimeout);
        ...
        /// <param name="commandTimeout">Timeout period in seconds for this command to execute</param>
        /// <returns>SqlDataReader containing the results of the command</returns>
        private static SqlDataReader ExecuteReader(SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, SqlConnectionOwnership connectionOwnership, int commandTimeout)
        {
            if (connection == null) throw new ArgumentNullException("connection");
            ...
            try
            {
                PrepareCommand(cmd, connection, transaction, commandType, commandText, commandParameters, out mustCloseConnection, commandTimeout);
        ...
        public static SqlDataReader ExecuteReader(string connectionString, CommandType commandType, string commandText, int commandTimeout, params SqlParameter[] commandParameters)
        {
            ...
            try
            {
                ...
                // Call the private overload that takes an internally owned connection in place of the connection string
                return ExecuteReader(connection, null, commandType, commandText, commandParameters, SqlConnectionOwnership.Internal, commandTimeout);
            }
            catch
            {
                // If we fail to return the SqlDatReader, we need to close the connection ourselves
        ...
        /// <param name="commandTimeout">Timeout period in seconds for this command to execute</param>
        /// <returns>A SqlDataReader containing the resultset generated by the command</returns>
        public static SqlDataReader ExecuteReader(SqlConnection connection, CommandType commandType, string commandText, int commandTimeout)
        {
            // Pass through the call providing null for the set of SqlParameters
        ...
        public static SqlDataReader ExecuteReader(SqlConnection connection, CommandType commandType, string commandText, int commandTimeout, params SqlParameter[] commandParameters)
        {
            ...
            return ExecuteReader(connection, (SqlTransaction)null, commandType, commandText, commandParameters, SqlConnectionOwnership.External, commandTimeout);
        }
        ...
        public static SqlDataReader ExecuteReader(SqlTransaction transaction, CommandType commandType, string commandText, int commandTimeout, params SqlParameter[] commandParameters)
        {
            ...
            // Pass through to private overload, indicating that the connection is owned by the caller
            return ExecuteReader(transaction.Connection, transaction, commandType, commandText, commandParameters, SqlConnectionOwnership.External, commandTimeout);
        }
        ...
        /// <remarks>
        /// e.g.:  
        ///  FillDatatable(connString, CommandType.StoredProcedure, "GetOrders", dt);
        /// </remarks>
        /// <param name="connectionString">A valid connection string for a SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        ...
        public static void FillDatatable(string connectionString, CommandType commandType,
        ...
        /// <remarks>
        /// e.g.:  
        ///  FillDatatable(connString, CommandType.StoredProcedure, "GetOrders", dt, new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">A valid connection string for a SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  FillDatatable(conn, CommandType.StoredProcedure, "GetOrders", dt);
        /// </remarks>
        /// <param name="connection">A valid SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  FillDatatable(conn, CommandType.StoredProcedure, "GetOrders", dt, new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">A valid SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  FillDatatable(trans, CommandType.StoredProcedure, "GetOrders", dt);
        /// </remarks>
        /// <param name="transaction">A valid SqlTransaction</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        ...
        public static void FillDatatable(SqlTransaction transaction, CommandType commandType,
            ...
            DataTable dataTable)
        {
            FillDatatable(transaction, commandType, commandText, dataTable, null);
        }
        ...
        /// <remarks>
        /// e.g.:  
        ///  FillDatatable(trans, CommandType.StoredProcedure, "GetOrders", dt, new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="transaction">A valid SqlTransaction</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  FillDatatable(conn, trans, CommandType.StoredProcedure, "GetOrders", dt, new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">A valid SqlConnection</param>
        /// <param name="transaction">A valid SqlTransaction</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        /// <param name="commandTimeout">Timeout period in seconds for this command to execute</param>
        public static void FillDatatable(string connectionString, CommandType commandType,
            string commandText, DataTable dataTable, int commandTimeout)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            if (dataTable == null) throw new ArgumentNullException("dataTable");
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                FillDatatable(connection, commandType, commandText, dataTable, commandTimeout);
            }
        }
            ...
            params SqlParameter[] commandParameters)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                FillDatatable(connection, commandType, commandText, dataTable, commandTimeout, commandParameters);
            }
        }
        ...
        public static void FillDatatable(SqlConnection connection, CommandType commandType,
            string commandText, DataTable dataTable, int commandTimeout)
        {
            FillDatatable(connection, commandType, commandText, dataTable, commandTimeout, null);
        }
        ...
        public static void FillDatatable(SqlConnection connection, CommandType commandType,
            ...
            params SqlParameter[] commandParameters)
        {
            FillDatatable(connection, null, commandType, commandText, dataTable, commandTimeout, commandParameters);
        }
        ...
        public static void FillDatatable(SqlTransaction transaction, CommandType commandType,
            ...
            DataTable dataTable)
        {
            FillDatatable(transaction, commandType, commandText, dataTable, commandTimeout, null);
        }
        ...
        public static void FillDatatable(SqlTransaction transaction, CommandType commandType,
            ...
            params SqlParameter[] commandParameters)
        {
            FillDatatable(transaction.Connection, transaction, commandType, commandText, dataTable, commandTimeout, commandParameters);
        }
            ...
            params SqlParameter[] commandParameters)
        {
            ...
            SqlCommand command = new SqlCommand();
            bool mustCloseConnection = false;
            PrepareCommand(command, connection, transaction, commandType, commandText, commandParameters, out mustCloseConnection, commandTimeout);
            ...
            string commandText, DataSet dataSet, string[] tableNames, params SqlParameter[] commandParameters)
        {
            ...
            using (SqlDataAdapter dataAdapter = new SqlDataAdapter(command))
            {
                ...
                {
                    // first table is just "Table"
                    string tableName = "Table";
                    for (int index = 0; index < tableNames.Length; index++)
                    {
                        if (tableNames[index] == null || tableNames[index].Length == 0) throw new ArgumentException("The tableNames parameter must contain a list of tables, a value was provided as null or empty string.", "tableNames");
                        dataAdapter.TableMappings.Add(tableName, tableNames[index]);
                        // all other tables have index appended to them
                        tableName = string.Concat("Table", (index + 1).ToString());
                    }
                }
        ...
        /// <param name="tableNames">This array will be used to create table mappings allowing the DataTables to be referenced
        /// by a user defined name (probably the actual table name)</param>
        public static void FillDataset(string connectionString, CommandType commandType, string commandText, int commandTimeout, DataSet dataSet, string[] tableNames)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            if (dataSet == null) throw new ArgumentNullException("dataSet");
        ...
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        /// <param name="dataSet">A dataset wich will contain the resultset generated by the command</param>
        /// <param name="tableName">This array will be used to create table mappings allowing the DataTables to be referenced
        /// by a user defined name (probably the actual table name)
        /// </param>
        public static void FillDataset(string connectionString, CommandType commandType,
            string commandText, int commandTimeout, DataSet dataSet, string tableName, int startRow, int numberOfRows,
            params SqlParameter[] commandParameters)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            if (dataSet == null) throw new ArgumentNullException("dataSet");
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                FillDataset(connection, commandType, commandText, commandTimeout, dataSet, tableName, startRow, numberOfRows, commandParameters);
            }
        }
        ...
        /// <param name="startRow">The position to start returned rows. </param>
        ...
        public static void FillDataset(SqlConnection connection, CommandType commandType,
            ...
            params SqlParameter[] commandParameters)
        {
            FillDataset(connection, null, commandType, commandText, commandTimeout, dataSet, tableName, startRow, numberOfRows, commandParameters);
        }
        ...
        public static void FillDataset(SqlConnection connection, CommandType commandType,
            ...
            params SqlParameter[] commandParameters)
        {
            FillDataset(connection, null, commandType, commandText, commandTimeout, dataSet, tableNames, commandParameters);
        }
        ...
        public static void FillDataset(SqlTransaction transaction, CommandType commandType,
            ...
            params SqlParameter[] commandParameters)
        {
            FillDataset(transaction.Connection, transaction, commandType, commandText, commandTimeout, dataSet, tableNames, commandParameters);
        }
        ...
        /// <param name="dataSet">A dataset wich will contain the resultset generated by the command</param>
        /// <param name="tableName">The name of the table to fill. </param>
        /// <param name="startRow">The postition to start returned rows. </param>
        /// <param name="numberOfRows">The numberOfRows to return. </param>
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        private static void FillDataset(SqlConnection connection, SqlTransaction transaction, CommandType commandType,
            string commandText, int commandTimeout, DataSet dataSet, string tableName, int startRow, int numberOfRows,
            params SqlParameter[] commandParameters)
        {
            ...
            using (SqlDataAdapter dataAdapter = new SqlDataAdapter(command))
            {
                if (tableName == null || tableName.Length == 0) throw new ArgumentException("The tableNames parameter must contain a list of tables, a value was provided as null or empty string.", "tableNames");
                dataAdapter.TableMappings.Add("Table" + tableName, tableName);


                // Fill the DataSet using default values for DataTable names, etc
                dataAdapter.Fill(dataSet, startRow, numberOfRows, tableName);
        ...
        /// <remarks>
        /// e.g.:  
        ///  UpdateDataset(connectionString, insertCommand, deleteCommand, updateCommand, dataSet, "Order");
        /// </remarks>
        /// <param name="connectionString">A valid connection string for a SqlConnection</param>
        /// <param name="insertCommand">A valid transact-SQL statement or stored procedure to insert new records into the data source</param>
        /// <param name="deleteCommand">A valid transact-SQL statement or stored procedure to delete records from the data source</param>
        ...
        /// <param name="dataSet">The DataSet used to update the data source</param>
        /// <param name="tableName">The DataTable used to update the data source.</param>
        public static void UpdateDataset(string connectionString, SqlCommand insertCommand, SqlCommand deleteCommand, SqlCommand updateCommand, DataSet dataSet, string tableName)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                UpdateDataset(insertCommand, deleteCommand, updateCommand, dataSet, tableName);
            }
        }
        ...
        /// <summary>
        /// Simplify the creation of a Sql command object.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ///  SqlCommand command = CreateCommand("usp_AddCustomer", SqlDbType.StoreProceedure, 50);
        /// </remarks>
        /// <param name="commandText">A valid transact-SQL statement or stored procedure</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandTimeout">Timeout period in seconds for this command to execute</param>
        /// <returns>A valid SqlCommand object</returns>
        public static SqlCommand CreateCommand(string commandText, CommandType commandType, int commandTimeout)
        {
        ...
        /// <remarks>
        /// e.g.:  
        ///  SqlCommand command = CreateCommand("usp_AddCustomer", SqlDbType.StoreProceedure, 50, new SqlParameter());
        /// </remarks>
        /// <param name="commandText">A valid transact-SQL statement or stored procedure</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandTimeout">Timeout period in seconds for this command to execute</param>
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        /// <returns>A valid SqlCommand object</returns>
        public static SqlCommand CreateCommand(string commandText, CommandType commandType, int commandTimeout, params SqlParameter[] commandParameters)
        {
            if (commandText == null) throw new ArgumentNullException("commandText");
    ...
    /// <summary>
    /// Enumeration of recognized Sql Server errors for catching 
    /// and handling appropriately
    /// </summary>
    public enum SqlErrorNumber : int
    {
        Unknown = 0,
        NullParameterValue = 21263,
        CustomUniqueIndex = 55000,
        CustomUniqueLoginDirectoryName = 55001,
        PrimaryKeyConstraint = 2627
    }
}
